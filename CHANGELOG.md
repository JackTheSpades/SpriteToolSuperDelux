...
- (Atari2.0) Make the -w command line option default to true, so now warnings are printed by default, -w is now deprecated and adding it to the command line does nothing.
